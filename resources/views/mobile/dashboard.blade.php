                    ...
                    <div data-bs-toggle="offcanvas" data-bs-target="#viewdetails" aria-controls="viewdetails"
                        ...
                        <div class="w-75">
                            <div class="d-flex align-items-center gap-3 osahan-mb-1">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1 d-flex align-items-center">Total Pemesanan </h6>
                                    <p class="text-muted text-truncate mb-0 small">Jumlah pesanan yang pernah
                                        dilakukan</p>
                                </div>
                            </div>
                        </div>
                        <div class="ms-auto d-flex align-items-center gap-3 text-center small">
                            <h6 class="fw-bold mb-1 d-flex align-items-center"><span class="text-danger fw-normal ms-2">
                                    {{ $totalPemesanan }}</span> </h6>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div data-bs-toggle="offcanvas" data-bs-target="#viewdetails" aria-controls="viewdetails"
                        ...
                        <div class="w-75">
                            <div class="d-flex align-items-center gap-3 osahan-mb-1">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1 d-flex align-items-center">Pemesanan Aktif </h6>
                                    <p class="text-muted text-truncate mb-0 small">Jumlah pesanan yang sedang berjalan</p>
                                </div>
                            </div>
                        </div>
                        <div class="ms-auto d-flex align-items-center gap-3 text-center small">
                            <h6 class="fw-bold mb-1 d-flex align-items-center"><span class="text-danger fw-normal ms-2">
                                    {{ $statistikPemesananAktif }}</span> </h6>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div data-bs-toggle="offcanvas" data-bs-target="#viewdetails" aria-controls="viewdetails"
                        ...
                        <div class="w-75">
                            <div class="d-flex align-items-center gap-3 osahan-mb-1">
                                ...
                                <div>
                                    <h6 class="fw-bold mb-1 d-flex align-items-center">Pemesanan Selesai </h6>
                                    <p class="text-muted text-truncate mb-0 small">Jumlah pesanan selesai</p>
                                </div>
                            </div>
                        </div>
                        <div class="ms-auto d-flex align-items-center gap-3 text-center small">
                            <h6 class="fw-bold mb-1 d-flex align-items-center"><span class="text-danger fw-normal ms-2">
                                    {{ $statistikPemesananSelesai }}</span> </h6>
                        </div>
                    </div>
                </div>
            </div>
